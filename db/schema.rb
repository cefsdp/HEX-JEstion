...
ActiveRecord::Schema.define(version: 2022_06_29_211441) do
  ...
  create_table "permissions", force: :cascade do |t|
    ...
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
    t.boolean "module_etude"
    t.boolean "module_adherent"
    t.boolean "module_client"
    t.boolean "module_membre"
    t.boolean "module_tresorerie"
    t.boolean "module_parametres"
